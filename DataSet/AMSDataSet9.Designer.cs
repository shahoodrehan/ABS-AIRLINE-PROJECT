...
namespace DBMSProject.DataSet.AMSDataSet9TableAdapters {
...
SELECT city_id, city, country_id FROM City WHERE (city_id = @city_id)";
        ...
        public virtual int Fill(AMSDataSet9.CityDataTable dataTable) {
        ...
        public virtual AMSDataSet9.CityDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AMSDataSet9.CityDataTable dataTable = new AMSDataSet9.CityDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AMSDataSet9.CityDataTable dataTable) {
