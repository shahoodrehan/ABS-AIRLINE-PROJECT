...
namespace DBMSProject.DataSet.AMSDataSet4TableAdapters {
...
SELECT city_id, city, country_id FROM City WHERE (city_id = @city_id)";
        ...
        public virtual int Fill(AMSDataSet4.CityDataTable dataTable) {
        ...
        public virtual AMSDataSet4.CityDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AMSDataSet4.CityDataTable dataTable = new AMSDataSet4.CityDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AMSDataSet4.CityDataTable dataTable) {
